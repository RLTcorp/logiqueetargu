...
const schemas = [
    ...
    // CH 3
    { chap: 3, name: "Argument ex concessis (à partir des concessions)", family: "Rhétorique", def: "S'appuyer sur les concessions (ce qui est déjà admis) de l'auditoire pour l'amener à une nouvelle conclusion.", q: "L'auditoire a-t-il vraiment admis ces prémisses ?", ex: ["Puisque vous admettez que la santé est prioritaire, vous devez accepter cette mesure sanitaire.", "Vous dites être un fervent écologiste, alors pourquoi prenez-vous l'avion tous les week-ends ?"] },
    ...
    { chap: 6, name: "Sophisme ad baculum (appel au bâton / à la force)", family: "Pressions", def: "Appel à la force/menace.", q: "Est-ce un argument ou une menace ?", ex: ["Soit tu valides ce budget, soit je te licencie.", "Tu dois croire en notre religion, sinon tu brûleras en enfer.", "Donne-moi ton goûter ou je te frappe à la récré."] },
    { chap: 6, name: "Sophisme ad misericordiam (appel à la pitié)", family: "Pressions", def: "Appel à la pitié pour biaiser le jugement.", q: "La pitié est-elle pertinente ici ?", ex: ["Ne me donnez pas d'amende, mon chat est malade.", "Donnez-moi une bonne note, j'ai étudié toute la nuit en pleurant.", "Vous devez m'embaucher, sinon je vais perdre ma maison."] },

    // CH 7
    { chap: 7, name: "Argument ad verecundiam (appel au respect de l'autorité)", family: "Autorité", def: "S'appuyer sur l'aura d'une autorité non experte en la matière.", q: "L'autorité citée est-elle experte dans CE domaine précis ?", ex: ["Ce shampoing est parfait, c'est Mbappé qui le dit.", "Einstein croyait en Dieu, donc Dieu existe.", "C'est vrai, je l'ai lu sur un blog obscur sur internet."] },
    { chap: 7, name: "Attaque ad hominem (contre la personne)", family: "Attaques", def: "Attaque sur la personne au lieu de l'argument.", q: "Le trait attaqué a-t-il un lien avec le sujet ?", ex: ["Tu dis qu'il faut réduire le sucre mais tu es gros.", "Comment peux-tu me parler d'écologie, toi qui roules en gros 4x4 ?", "Les arguments de cet économiste sont faux car il a trompé sa femme."] },
    { chap: 7, name: "Tu quoque (toi aussi)", family: "Attaques", def: "Incohérence entre les dires et actes de l'orateur.", q: "Son comportement invalide-t-il la vérité de son propos ?", ex: ["Le pneumologue me dit d'arrêter de fumer, mais lui fume !", "Tu me dis de ne pas mentir, mais tu as menti la semaine dernière.", "Pourquoi devrais-je respecter la limite de vitesse ? Les policiers eux-mêmes la dépassent !"] },
    { chap: 7, name: "Petitio principii (pétition de principe)", family: "Preuve", def: "Raisonnement circulaire.", q: "La conclusion est-elle déjà admise dans la prémisse ?", ex: ["Il dit la vérité car il ne ment jamais.", "La Bible est la parole de Dieu parce qu'elle le dit elle-même.", "Ce livre est passionnant parce qu'il n'est pas ennuyeux."] },
    { chap: 7, name: "Ad ignorantiam (appel à l'ignorance)", family: "Preuve", def: "Demander à l'adversaire de prouver que l'on a tort (Renversement de charge de preuve).", q: "A qui incombe la preuve ?", ex: ["Prouve-moi que les extraterrestres n'existent pas !", "Personne n'a prouvé que les fantômes n'existent pas, donc ils existent.", "Si tu ne peux pas expliquer comment l'univers a été créé, c'est que c'est magique."] }
];
